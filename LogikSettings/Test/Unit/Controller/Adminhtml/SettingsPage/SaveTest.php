...
namespace Logik\LogikSettings\Test\Unit\Controller\Adminhtml\SettingsPage;

use Logik\LogikSettings\Controller\Adminhtml\SettingsPage\Save;
...
class SaveTest extends TestCase
{
    ...
    public function testIsAllowed()
    {
        ...
        $authorization->expects($this->once())
            ->method('isAllowed')
            ->with('Logik_LogikSettings::logik_settingspage')
            ->willReturn(true);
